...
class LM_model(nn.Module):
    def __init__(self, model, hidden_dim, emb_dim, vocab_len, use_dropout, pad_index, emb_dropout=0.1, out_dropout=0.1):
        ...
        self.embedding = nn.Embedding(vocab_len, emb_dim, padding_idx=pad_index)
